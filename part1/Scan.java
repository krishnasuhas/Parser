...
public class Scan {
	...
	while(true) {
		...
		switch( c ) {
			...
			return ccase1('<',TK.DO);
		    case '>':
			return ccase1('>',TK.ENDDO);// this case added because of end of do sign is missing
		    case '~':
			return ccase1('~',TK.SCOPING);// this case added because of scoping token is needed in operations like acessing a particular variable in different scopes			
		    case '=':
			return ccase1('=',TK.ASSIGN);// this case added because of equal sign is compulsory needed token in most operations
		    case EOF:
			got_eof = true;
