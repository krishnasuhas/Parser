...
public class TK {
    ...
    public static final TK ASSIGN = new TK("TK.ASSIGN");   // = this object created because of equal sign is compulsory needed token in most operations
    public static final TK DOWHILE = new TK("TK.ENDDO"); // > this object created because end of do sign is missing
    public static final TK SCOPING = new TK("TK.SCOPING"); // ~ this object created because of scoping is possible in e languge
