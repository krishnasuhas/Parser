...
public class TK {
    ...
    public static final TK DOWHILE = new TK("TK.DOWHILE"); // >
    public static final TK SCOPING = new TK("TK.SCOPING"); // ~
    public static final TK FOR 	   = new TK("TK.FOR"); 	   // " - for
    public static final TK ENDFOR  = new TK("TK.ENDFOR");  // ` - ENDFOR
    public static final TK INFOR   = new TK("TK.INFOR");   // ; - INFOR
    public static final TK LESSTHAN= new TK("TK.LESSTHAN");// $ - lessthan
    public static final TK GRTTHAN = new TK("TK.GRTTHAN"); // & - greater than
    public static final TK COMMA  = new TK("TK.COMMA");    // ,
    public static final TK ENDFORBLK  = new TK("TK.ENDFORBLK");// ? END FOR BLK
